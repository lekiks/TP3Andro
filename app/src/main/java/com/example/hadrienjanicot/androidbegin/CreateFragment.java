...
public class CreateFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button createBottleBtn = rootView.findViewById(R.id.f_main_btn_createB);
        final EditText editName = rootView.findViewById(R.id.f_main_input_name);
        final EditText editPrice = rootView.findViewById(R.id.f_main_input_price);
    ...
    public void onButtonPressed(Bottle b) {
        if (mListener != null) {
            mListener.AddBottle(b);
        }
    }
